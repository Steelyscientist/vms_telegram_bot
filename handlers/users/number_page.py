...
async def contact_handler(message: types.Message, state: FSMContext):
    ...
    if contact.phone_number:
        ...
        await message.answer("Iltimos, tugma yordamida kontakt ma'lumotlaringizni yuboring.")
...
async def handle_invalid_contact(message: types.Message, state: FSMContext):
    ...
    await message.answer("Iltimos, tugma yordamida kontakt ma'lumotlaringizni baham ko'ring.")
...
async def contact_handler(message: types.Message, state: FSMContext):
    ...
    if contact.phone_number:
        ...
        await message.answer("Пожалуйста, поделитесь своей контактной информацией, используя кнопку.")
